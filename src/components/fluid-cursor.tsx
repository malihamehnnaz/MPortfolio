...
export default function FluidCursor() {
  ...
  useEffect(() => {
    ...
    const initFluid = () => {
        ...
        function getWebGLContext(canvas: HTMLCanvasElement): { gl: WebGLRenderingContext | WebGL2RenderingContext | null, ext: any } {
            ...
            if (!supportRenderTextureFormat(gl, internalFormat, format, type)) {
                if (gl instanceof WebGL2RenderingContext) {
                    switch (internalFormat) {
                        case gl.R16F:
                            return getSupportedFormat(gl as WebGL2RenderingContext, gl.RG16F, gl.RG, type);
                        case gl.RG16F:
                            return getSupportedFormat(gl as WebGL2RenderingContext, gl.RGBA16F, gl.RGBA, type);
                        default:
                            return null;
                    }
                }
        ...
        const onTouchMove = (e: TouchEvent) => {
            ...
            for (let i = 0; i < touches.length; i++) {
                ...
                if (!pointer) pointer = pointers[i] = new (pointerPrototype as any)();
